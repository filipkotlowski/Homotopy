    ...
    <div class="hover:cursor-pointer">
        <v-menu :close-on-content-click="false" location="bottom">
            <template v-slot:activator="{ props }">
                <v-img height="36" width="36" cover src="https://placehold.co/100x100" class="rounded-full"
                    v-bind="props" />
            </template>
            <v-card min-width="300">
                <v-list>
                    <v-list-item prepend-avatar="https://placehold.co/100x100" subtitle="Founder of Vuetify"
                        title="John Leider">
                    </v-list-item>
                </v-list>
                <v-list>
